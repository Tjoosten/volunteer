		...
		<div class="row">
			<div class="col-md-4">
				<div class="card card-padding">
					<img class="card-img-top" style="width:100%; height: 200px;" src="img/welfare.jpg" alt="Card image cap">
			...
			<div class="col-md-4">
				<div class="card card-padding">
					<img class="card-img-top" style="width:100%; height: 200px;" src="img/developer.jpg" alt="Card image cap">
					<div class="card-block">
			...
			<div class="col-md-4">
				<div class="card card-padding">
					<img class="card-img-top" style="width:100%; height: 200px;" src="img/volunteer.jpg" alt="Card image cap">
					<div class="card-block">
			...
			<div class="col-md-4">
				<div class="card card-padding">
					<img class="card-img-top" style="width:100%; height: 200px;" src="img/activist.png" alt="Card image cap">
					<div class="card-block">
			...
			<div class="col-md-4">
				<div class="card card-padding">
					<img class="card-img-top" style="width:100%; height: 200px;" src="img/writer.jpg" alt="Card image cap">
					<div class="card-block">
			...
			<div class="col-md-4">
				<div class="card card-padding">
					<img class="card-img-top" style="width:100%; height: 200px;" src="img/grafisch.png" alt="Card image cap">
					<div class="card-block">
